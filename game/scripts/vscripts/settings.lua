...
FORCE_PICKED_HERO = "npc_dota_hero_monkey_king"  -- What hero should we force all players to spawn as? (e.g. "npc_dota_hero_axe").  Use nil to allow players to pick their own hero.

FIXED_RESPAWN_TIME = 100                 -- What time should we use for a fixed respawn timer?  Use -1 to keep the default dota behavior.
